...
const Footer = () => {
  ...
  return (
    <div className="pt-[8rem] pb-[16vh] bg-[#02050a]">
      <div className="flex flex-col justify-center md:flex-row border-b-[1px] pb-[6rem] border-gray-400 w-[80%] mx-auto gap-[3rem]">
        ...
        <button
          ...
          className="px-[2rem] hover:bg-yellow-400 transition-all duration-200 py-[1rem] text-[10px] font-bold uppercase bg-[#55e6a5] text-black flex items-center justify-center space-x-2"
        >
      ...
      <div className="w-[80%] border-t-[1px] border-gray-400 pt-[2rem] mx-auto flex justify-around text-center">
        ...
        <div className="flex items-center space-x-10 text-white opacity-20">
          ...
          <a href="https://linkedin.com/in/NathanPannell">
            <svg
              stroke="currentColor"
              fill="currentColor"
              stroke-width="0"
