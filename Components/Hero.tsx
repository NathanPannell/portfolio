...
const Hero = () => {
  return (
    <div className="mt-[12vh] h-[88vh] bg-[url('/images/banner.jpg')] bg-cover bg-center">
      <Particle />
      <div className="w-[80%] grid-cols-1 mx-auto grid lg:grid-cols-2 gap-[3rem] h-[100%] items-center">
        <div>
          ...
          <p className="mt-[2rem] text-[18px] text-[#ffffff92]">
            ...
            officia vel, saepe itaque quia nihil vero, sunt possimus voluptas
            animi repellat deserunt laborum nobis quisquam.
          </p>
